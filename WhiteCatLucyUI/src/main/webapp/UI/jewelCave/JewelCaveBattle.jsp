...
<link href="style/jewelCave/battle.css" rel="stylesheet" type="text/css">
...
<body>
	<div class="display">
		<div class="scriptBox"> <h3>어떻게 할까?</h3> 
				<button type="button" class="button-move button-effect" onclick="location.href='./jewelCaveBattleScript1'">일반공격</button>
