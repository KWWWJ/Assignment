 ...
 */
@WebServlet("/cloudBattle")
public class Battle extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7883043270652420628L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/cloud/CloudBattle.jsp");
