 ...
 */
@WebServlet("/cloudBattleStart")
public class BattleStart extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1830532802645380413L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/cloud/CloudBattleStart.jsp");
