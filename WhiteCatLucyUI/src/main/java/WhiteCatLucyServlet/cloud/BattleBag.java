 ...
 */
@WebServlet("/cloudBattleBag")
public class BattleBag extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7970858853144165166L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/cloud/CloudBattleBag.jsp");
