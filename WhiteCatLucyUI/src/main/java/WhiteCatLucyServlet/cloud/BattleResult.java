 ...
 */
@WebServlet("/cloudBattleResult")
public class BattleResult extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -6728917050361573072L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/cloud/CloudBattleResult.jsp");
