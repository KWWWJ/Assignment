 ...
 */
@WebServlet("/alley")
public class Alley extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1951201162232613414L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/alley/Alley.jsp");
