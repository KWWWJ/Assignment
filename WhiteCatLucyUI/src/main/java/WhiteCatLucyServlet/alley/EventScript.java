 ...
 */
@WebServlet("/alleyEventScript")
public class EventScript extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7578336709021593378L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/alley/AlleyEventScript.jsp");
