 ...
 */
@WebServlet("/alleyBattleStart")
public class BattleStart extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3754389082802723435L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/alley/AlleyBattleStart.jsp");
