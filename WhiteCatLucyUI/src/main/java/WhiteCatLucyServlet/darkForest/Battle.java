 ...
 */
@WebServlet("/darkForestBattle")
public class Battle extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2332610865218404013L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFBattle.jsp");
