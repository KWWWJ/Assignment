 ...
 */
@WebServlet("/darkForestBattleResult")
public class BattleResult extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3076269941273294711L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFBattleResult.jsp");
