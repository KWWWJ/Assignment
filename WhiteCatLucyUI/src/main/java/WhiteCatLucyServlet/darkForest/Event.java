 ...
 */
@WebServlet("/darkForestEvent")
public class Event extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 9048973270681284826L;
...
//		request.setAttribute("box", nowScript);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFEvent.jsp");
