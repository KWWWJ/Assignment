 ...
 */
@WebServlet("/darkForestBattleBag")
public class BattleBag extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7014135532552479705L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFBattleBag.jsp");
