 ...
 */
@WebServlet("/darkForestEventScript")
public class EventScript extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -3969996915361427568L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFEventScript.jsp");
