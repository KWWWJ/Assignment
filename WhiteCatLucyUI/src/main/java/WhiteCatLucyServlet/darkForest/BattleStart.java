 ...
 */
@WebServlet("/darkForestBattleStart")
public class BattleStart extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1401892475671178300L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/darkForest/DFBattleStart.jsp");
