 ...
 */
@WebServlet("/roadBattle")
public class Battle extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4989706261026610705L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/road/RoadBattle.jsp");
