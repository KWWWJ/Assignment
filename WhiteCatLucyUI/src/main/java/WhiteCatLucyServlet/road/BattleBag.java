 ...
 */
@WebServlet("/roadBattleBag")
public class BattleBag extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -1424272775680942971L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/road/RoadBattleBag.jsp");
