 ...
 */
@WebServlet("/roadBattleScript2")
public class BattleScript2 extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 4592715907038662471L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/road/RoadBattleScript2.jsp");
