 ...
 */
@WebServlet("/roadEvent")
public class Event extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 390063056626739864L;
...
//		request.setAttribute("box", nowScript);
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/road/RoadEvent.jsp");
