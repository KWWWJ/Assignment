 ...
 */
@WebServlet("/roadBattleStart")
public class BattleStart extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2911598276697487774L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/road/RroadBattleStart.jsp");
