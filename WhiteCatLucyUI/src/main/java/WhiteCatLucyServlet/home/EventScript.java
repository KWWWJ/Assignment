package WhiteCatLucyServlet.home;
 ...
 */
@WebServlet("/homeEventScript")
public class EventScript extends HttpServlet {
	/**
	 * 
	 */
	private static final long serialVersionUID = 5009968393869459828L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("/UI/home/HomeEventScript.jsp");
