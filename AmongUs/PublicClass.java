...
class Character
{
	...
	public static int meetingTime = 0; //회의 시간 15초
	public static int voteTime = 0; //투표시간 120초
	...
	public static int publicMission = 1; //모든 사람에게 보이는 미션
	public static int complicationMission = 1; //연계가 있는 미션
	public static int simpleMission = 2; //간단한 미션
	public static String nicName = " "; //유저정보로 부터 가져옴
	public static int up = 0; //1로 바뀌면 활성화
	public static int down = 0;//1로 바뀌면 활성화
	public static boolean colorClose = true; //캐릭터 색상 선택 불가
